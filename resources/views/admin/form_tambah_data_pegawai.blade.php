            ...
            <div class="ibox float-e-margins">
             ...
             <form id="form-pekerja" data-parsley-validate="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" readonly="" class="form-control" name="tgl_lahir" id="expired" placeholder="Masukkan Tanggal Lahir" required="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="radio-inline radio radio-primary"> <input type="radio" class="radio-primary" name="jenis_kelamin" id="jk" value="L" required=""><label for="jk" style="cursor: pointer;">Laki-Laki</label></div>
                                <div class="radio-inline radio radio-primary"> <input type="radio" class="radio-primary" name="jenis_kelamin" id="jk2" value="P"  required=""><label for="jk2" style="cursor: pointer;">Perempuan</label></div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="radio-inline radio radio-primary"> <input type="radio" class="radio-primary" name="agama" id="agama" value="protestan"  required=""><label style="cursor: pointer;">Protestan</label></div>
                                <div class="radio-inline radio radio-primary"> <input type="radio" class="radio-primary" name="agama" id="agama" value="katolik" required=""><label style="cursor: pointer;">Katolik</label></div>
